...
import { CompressedTexture, FileLoader, LinearFilter, LinearMipmapLinearFilter, Loader, RGBA_ASTC_4x4_Format, RGBA_PVRTC_4BPPV1_Format, RGB_ETC1_Format, RGB_PVRTC_4BPPV1_Format, UnsignedByteType } from "../../../build/three.module.js";
...
BasisTextureLoader.prototype = Object.assign(Object.create(Loader.prototype), {
  ...
  */
	_createTexture: function (buffer) {
		...
		var texturePending = this._getWorker().then(_worker => {
...
//# sourceMappingURL=BasisTextureLoader-compiled.js.map