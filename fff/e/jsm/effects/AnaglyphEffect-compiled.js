...
import { LinearFilter, Matrix3, Mesh, NearestFilter, OrthographicCamera, PlaneBufferGeometry, RGBAFormat, Scene, ShaderMaterial, StereoCamera, WebGLRenderTarget } from "../../../build/three.module.js";
...
var AnaglyphEffect = function (renderer, width, height) {
	...
	this.colorMatrixLeft = new Matrix3().fromArray([1.0671679973602295, -0.0016435992438346148, 0.0001777536963345483, // r out
	...
	this.colorMatrixRight = new Matrix3().fromArray([-0.0355340838432312, -0.06440307199954987, 0.018319187685847282, // r out
...
//# sourceMappingURL=AnaglyphEffect-compiled.js.map