...
import { Color, LightProbe, LinearEncoding, SphericalHarmonics3, Vector3, sRGBEncoding } from "../../../build/three.module.js";
		...
		for (var faceIndex = 0; faceIndex < 6; faceIndex++) {
			...
			for (var i = 0, il = data.length; i < il; i += 4) {
				...
				switch (faceIndex) {
					...
					case 0:
						coord.set(-1, row, -col);break;

					case 1:
						coord.set(1, row, col);break;

					case 2:
						coord.set(-col, 1, -row);break;

					case 3:
						coord.set(-col, -1, row);break;

					case 4:
						coord.set(-col, row, 1);break;
...
//# sourceMappingURL=LightProbeGenerator-compiled.js.map