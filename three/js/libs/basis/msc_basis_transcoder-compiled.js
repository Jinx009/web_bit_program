...
var MSC_TRANSCODER = function () {
  ...
  return function (MSC_TRANSCODER) {
    ...
    var Module = typeof MSC_TRANSCODER !== "undefined" ? MSC_TRANSCODER : {};var moduleOverrides = {};var key;for (key in Module) {
    ...
    }var wasmMemory;var wasmTable = new WebAssembly.Table({ "initial": 70, "maximum": 70 + 0, "element": "anyfunc" });var ABORT = false;var EXITSTATUS = 0;function assert(condition, text) {
      if (!condition) {
    ...
    }var UTF16Decoder = typeof TextDecoder !== "undefined" ? new TextDecoder("utf-16le") : undefined;var WASM_PAGE_SIZE = 65536;function alignUp(x, multiple) {
      if (x % multiple > 0) {
    ...
    }var DYNAMIC_BASE = 5568704,
        DYNAMICTOP_PTR = 325664;var INITIAL_TOTAL_MEMORY = Module["TOTAL_MEMORY"] || 16777216;if (Module["wasmMemory"]) {
    ...
    }var wasmBinaryFile = "msc_basis_transcoder.wasm";if (!isDataURI(wasmBinaryFile)) {
      ...
      return _malloc(size);
    }var ___exception_infos = {};var ___exception_last = 0;function ___cxa_throw(ptr, type, destructor) {
      ...
      var shift = getShiftFromSize(size);name = readLatin1String(name);function ctor() {}ctor.values = {};registerType(rawType, { name: name, constructor: ctor, "fromWireType": function (c) {
      ...
      name = readLatin1String(name);var getHeap, shift;if (charSize === 2) {
        ...
        getHeap = function () {
          ...
          var length = value.length;var ptr = _malloc(4 + length * charSize);var HEAP = getHeap();HEAPU32[ptr >> 2] = length;var start = ptr + 4 >> shift;for (var i = 0; i < length; ++i) {
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = MSC_TRANSCODER;else if (typeof define === 'function' && define['amd']) define([], function () {
  return MSC_TRANSCODER;
});else if (typeof exports === 'object') exports["MSC_TRANSCODER"] = MSC_TRANSCODER;

//# sourceMappingURL=msc_basis_transcoder-compiled.js.map