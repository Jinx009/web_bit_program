 ...
 */
	...
	switch (strResolution) {
		...
		case "low":
			fResolution = 0.25;break;
		case "medium":
			fResolution = 0.5;break;
		case "high":
			fResolution = 1;break;
	...
	if (strResolution == "low") {
		...
		switch (iScale) {
			...
			case 1:
				fLetterSpacing = -1;break;
			case 2:
			case 3:
				fLetterSpacing = -2.1;break;
			case 4:
				fLetterSpacing = -3.1;break;
			case 5:
				fLetterSpacing = -4.15;break;
	...
	if (strResolution == "medium") {
		...
		switch (iScale) {
			...
			case 1:
				fLetterSpacing = 0;break;
			case 2:
				fLetterSpacing = -1;break;
			case 3:
				fLetterSpacing = -1.04;break;
			case 4:
			case 5:
				fLetterSpacing = -2.1;break;
...
//# sourceMappingURL=AsciiEffect-compiled.js.map