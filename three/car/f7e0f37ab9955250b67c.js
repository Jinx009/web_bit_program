webpackJsonp([1], {
    "17N7": function (t, e) {
        ...
        var n = i("7+uW"), a = i("Ml+6"), r = i("bOdI"), o = i.n(r), s = i("/lXX"), c = i.n(s), l = new a.AnimationMixer, d = new a.Clock, p = new a.Scene, h = window.innerWidth, u = window.innerHeight, m = h / u, g = new a.OrthographicCamera(-60 * m, 60 * m, 60, -60, 1, 1e3);
        ...
        var x = {
            ...
            created: function () {
                ...
                var e = new a.gac, i = new a.TextureLoader, n = i.load("./car/dif" + "fuse.j" + "pg"), r = i.load("./car/wheel.png"), s = (new a.CubeTextureLoader).setPath("./car/env/").load(["px.jpg", "nx.jpg", "py.jpg", "ny.jpg", "pz.jpg", "nz.jpg"]);
                s.minFilter = a.NearestFilter, e.ld(this.src, function (e) {
                    ...
                    var c = new a.ColorKeyframeTrack(".material.color", [0, 10, 20, 30], [.5, .5, .5, .9, .1, .1, .1, .1, .9, .42, .28, .84]), d = new a.AnimationClip("default", 40, [c]);
        ...
        var P = i("VU/8")(L, S, !1, function (t) {
            i("17N7")
        }, null, null).exports, R = i("zL8q"), C = i.n(R);
        i("tvR6");
